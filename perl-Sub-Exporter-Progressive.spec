%{?scl:%scl_package perl-Sub-Exporter-Progressive}

Name:		%{?scl_prefix}perl-Sub-Exporter-Progressive
Version:	0.001013
Release:	11%{?dist}
...
BuildRequires:	%{?scl_prefix}perl(Exporter) >= 5.58
...
Requires:	%{?scl_prefix}perl(Exporter) >= 5.58
Requires:	%{?scl_prefix}perl(Sub::Exporter)
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.001013-11
- SCL
